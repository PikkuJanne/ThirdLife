# ThirdLife Setup Core — Portfolio Boundary and Late-Integration Contract

**Status:** Binding project boundary  
**Bundle version:** 0.2.0  
**Portfolio source:** *ThirdLife Software Portfolio — Two-Team Development Roadmap and Boundary Architecture*, version 2.0, 14 August 2026  
...
ThirdLife Setup Core helps a refurbisher, volunteer, support worker, or recipient assess and prepare a Windows PC using safe, supported, understandable actions. It must remain useful, installable, removable, recoverable, and supportable without any sibling portfolio application.
...
- human-assisted hardware and functional tests;
...
- action journaling, restart recovery, independent verification, and cold-boot acceptance;
...
- its own installer, update, repair, uninstall, data migration, support, threat model, accessibility evidence, and low-spec evidence.
...
B1 is developed in its own repository and its own vacuum.
...
## 6. Integration preparation allowed during B1
...
1. stable product identity and version;
...
9. known limitations, offline behavior, and practical resource evidence.
...
## 7. Integration prohibited during B1
...
## 9. Standalone release and team transition
...
- installer/package and cryptographic hashes;
- source revision and dependency lock;
- SBOM, licence evidence, and third-party notices;
- security, privacy, accessibility, low-spec, offline, update, repair, uninstall, and data-preservation evidence;
...
A normal Codex task may improve ThirdLife Setup Core within this boundary. Any proposal to add a sibling domain, shared portfolio infrastructure, a live cross-project dependency, or B4 adapter work must stop at a documented decision point and obtain portfolio-owner approval.
