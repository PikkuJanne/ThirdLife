...
| `CRM-001`–`CRM-011` domain/provider/resource/manual coverage | `Not run` unless separately recorded by an owning task | Named paths/versions/hashes/commands remain owning-task work | None from `TL-0105` | None |
